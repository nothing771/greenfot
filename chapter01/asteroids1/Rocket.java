...
/**
 * A rocket that can be controlled by the arrowkeys: up, left, right. The gun is fired by hitting the 'space' key.
 * @author Poul Henriksen @author Michael Kolling
 */
public class Rocket extends Mover
{
    ...
    /**
     * Do what a rocket's gotta do. (Which is: mostly flying about, and turning, accelerating and shooting when the right keys are pressed.)
     */
    public void act()
    {
        move();
    ...
    public int getSpeed()
    {
        return (int)(getMovement().getLength() * 8);
    }

    /**
     * Set the time needed for re-loading the rocket's gun. The shorter this time is, the faster the rocket can fire. The (initial) standard time is 20.
     */
